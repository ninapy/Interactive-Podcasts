...
- `analysis/analysis.py` , `analysis/visualizations.ipynb` and `analysis/CS_1377_Final_Visualizations.ipynb`: contains the statistical analysis for the experiment testing the tool's effectiveness on information retention, including ANOVA, t-tests, and performance breakdowns by group and question format and their corresponding visualizations.
